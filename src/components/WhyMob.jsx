...
const WhyMob = () => {
	const data = [
		{
			t: (
				<h3 className="f20 fw700 text-white">
					<span className="bottomLineGray pb-2">Next gene</span>ration
					technology
				</h3>
			),
			d: "Sleek and smart",
		},
		{
			t: (
				<h3 className="f20 fw700 text-white">
					<span className="bottomLineGray pb-2">Bespok</span>e
				</h3>
			),
		...
		},
		{
			t: (
				<h3 className="f20 fw700 text-white">
					<span className="bottomLineGray pb-2">Seamle</span>ss ease of use
				</h3>
			),
		...
		},
		{
			t: (
				<h3 className="f20 fw700 text-white">
					<span className="bottomLineGray pb-2">Compe</span>titive transaction
					fee
				</h3>
			),
		...
		},
		{
			t: (
				<h3 className="f20 fw700 text-white">
					<span className="bottomLineGray pb-2">Simple </span>SDK and in-app API
				</h3>
			),
	...
	return (
		<div className="whyMob_container">
			<div className="inner_whyMob_container">
						...
						<div className="row">
							<div className="col-11 col-lg-12 mx-auto">
								<div className="whyMobTop">
									<p className="f18 topP orangeC mb-0 mb-md-2">Why Dapio?</p>
									<h1 className="fw600">
								...
								<div className="row">
									{data.map((prev, i) => {
										const { t, d } = prev;
										return (
											<div key={i} className="mobCard col-12 col-md-6 mt-4">
												{t}
												<p className="mt-3 f14 fw-bold mt-md-4 pt-2 pt-md-3">
													{d}
												</p>
											</div>
										);
