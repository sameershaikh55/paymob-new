...
const MoDetails = ({ adminP }) => {
	...
	if (adminP) {
		data = [
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">Branded</span> experience
					</h5>
				),
			...
			},
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">At a gla</span>nce
						reporting
					</h5>
				),
			...
			},
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">Access a</span>
						nywhere, anytime
					</h5>
				),
			...
			},
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">Transac</span>tion
						overview
					</h5>
				),
		...
		data = [
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">Ready-to</span>-go
					</h5>
				),
			...
			},
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">Time sa</span>ving
					</h5>
				),
			...
			},
			{
				t: (
					<h5 className={`${(adminP && "text-white") || "color1"} fw600 mb-4`}>
						<span className="bottomLineGrayDark pb-2">Seamless</span> KYC
					</h5>
				),
	...
	return (
		<div className={`sdk_detail_container ${!adminP && "sdk_detail_light"}`}>
