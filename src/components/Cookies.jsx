		...
		<div className="cookies_container">
			...
			>
				<div className="py-4 px-3 px-md-5">
					<h2 className="text-center gotham f24 fw-bold">
						Privacy Policy and Cookies
					</h2>

					<p className="text-center mt-4 f12 gotham fw-bold">
					...
					<div className="d-flex justify-content-center mt-4">
						<button
							onClick={handleClose}
							className="bg-white border-0 rounded-pill f12 fw-bold gotham me-3 me-md-5"
						>
							Yes, I accept Cookies.
						</button>
						<button
							onClick={handleClose}
							className="bg-white border-0 rounded-pill f12 fw-bold gotham"
						>
							No, thanks.
						</button>
					</div>
